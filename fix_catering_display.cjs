...
// ═══════════════════════════════════════════════════════════════════
// FIX 1: WelcomeScreen — show catering logo + name prominently
// ═══════════════════════════════════════════════════════════════════
const wsPath = BASE + '/components/guest/WelcomeScreen.jsx'
let wsContent = fs.readFileSync(wsPath, 'utf8')

// Replace the content section that shows event name
...
console.log('✅ 1/2 WelcomeScreen — catering logo + name shown prominently')

// ═══════════════════════════════════════════════════════════════════
// FIX 2: MenuScreen — show catering logo + name in header top bar
// ═══════════════════════════════════════════════════════════════════
...
console.log('✅ 2/2 MenuScreen — catering logo + name in top header bar')
